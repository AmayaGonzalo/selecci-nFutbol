...
var futbolistaUno = new Futbolista_1.Futbolista("Lionel", "Messi", 35, false, 10);
var futbolistaDos = new Futbolista_1.Futbolista("Lautaro", "Martinez", 25, false, 22);
var futbolistaTres = new Futbolista_1.Futbolista("Franco", "Armani", 35, false, 1);
