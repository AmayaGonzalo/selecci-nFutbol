...
let futbolistaUno: Futbolista = new Futbolista ("Lionel", "Messi", 35, false, 10, 21, 11)
let futbolistaDos: Futbolista = new Futbolista ("Lautaro", "Martinez", 25, false, 22, 21, 11);
let futbolistaTres: Futbolista = new Futbolista ("Franco", "Armani", 35, false,  1, 21, 11)
